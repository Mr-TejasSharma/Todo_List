...
function Home() {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        const res = await fetch("https://todo-list-03da.onrender.com/get-tasks", {
          method: "POST",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://todo-list-03da.onrender.com/add-task", {
        method: "POST",
        headers: {
  ...
  const handleDelete = async (index) => {
    try {
      const res = await fetch("https://todo-list-03da.onrender.com/delete-task", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
